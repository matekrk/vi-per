...
class Options():
    def __init__(self):
        ...
        self.parser.add_argument('--rez_dir', required=True, default="./", help='path to the results directory where trainer_NAME/Data|Train to be saved.')
        ...
        self.parser.add_argument('--model', required=True, default='alexnet', help='model type. [Alexnet | LightenB | VGG16 | Resnet18 | ... | SimpleMLP | SimpleConv | Lenet]')
        self.parser.add_argument('--binary_squeezed', action='store_true', default=False, help='for binary attributes squeeze last layer')
        self.parser.add_argument('--notimage_type', action='store_true', default=False, help='allow proceed synthetic (1D data)')
        self.parser.add_argument('--hidden_size', type=int, default=64, help='hidden size for mlp/conv layers')
        ...
        self.parser.add_argument('--randomized_selection', action='store_true', help='default false. Sample randomly and determine in which data split type samples should be')
        ...
        ## bayesian
        self.parser.add_argument('--bayesian', action='store_true', help='bayesian last layer')
        self.parser.add_argument('--method', type=str, default = None, help='method for bayesian')
        self.parser.add_argument('--n_samples', type=int, default = None, help='for mc for bayesian')
        self.parser.add_argument('--l_max', type=float, default = None, help='for tb for bayesian')
        self.parser.add_argument('--mu', default = None)
        self.parser.add_argument('--sig', default = None)
        self.parser.add_argument('--Sig', default = None)
        self.parser.add_argument('--s_init', default = None)
        self.parser.add_argument('--intercept', action='store_true', help='bias for bayesian last layers')
