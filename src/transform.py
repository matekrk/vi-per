...
def find_intersection(set_1, set_2):
    ...
    :return: intersection of each of the boxes in set 1 with respect to each
             of the boxes in set 2, a tensor of dimensions (n1, n2)
    """
...
def find_jaccard_overlap(set_1, set_2):
    """
    Find the Jaccard Overlap (IoU) of every box combination between two sets
    of boxes that are in boundary coordinates.
    :param set_1: set 1, a tensor of dimensions (n1, 4)
    :param set_2: set 2, a tensor of dimensions (n2, 4)
...
def expand(image, boxes, filler):
    ...
    :param boxes: bounding boxes in boundary coordinates, a tensor of 
                  dimensions (n_objects, 4)
    ...
    # place the original image at random coordinates in this new...
    # ...image (origin at top-left of image)
...
def random_crop(image, boxes, labels):
    ...
    while True:
        ...
        # this isn't mentioned in the paper, of course,...
        # ...but 50 is chosen in paper authors' original Caffe repo
        max_trials = 50
        for _ in range(max_trials):
            # crop dimensions must be in [0.3, 1] of original dimensions
            # note - it's [0.1, 1] in the paper,...
            # ...but actually [0.3, 1] in the authors' repo
            min_scale = 0.3
            ...
            # sspect ratio has to be in [0.5, 2]
...
def resize(image, boxes, dims=(300, 300), return_percent_coords=True):
    ...
    Since percent/fractional coordinates are calculated for the bounding
    boxes (w.r.t image dimensions) in this process,
    you may choose to retain them.

    :param image: image, a PIL Image
    :param boxes: bounding boxes in boundary coordinates, 
                  a tensor of dimensions (n_objects, 4)
    :return: resized image, updated bounding box coordinates 
            (or fractional coordinates, in which case they remain the same)
    """
    # resize image
...
def transform(image, boxes, labels, split, new_dims=(300, 300)):
    """
    ...
    :param difficulties: difficulties of detection of these objects, 
                         a tensor of dimensions (n_objects)
    :param split: one of 'TRAIN' or 'TEST', since different sets of 
    ...
    # Mmean and standard deviation of ImageNet data that our base VGG from...
    ...
    if split == 'TRAIN':
        ...
        # fill surrounding space with the mean of ImageNet data that our...
    ...
    new_image, new_boxes = resize(new_image, new_boxes, dims=new_dims)
